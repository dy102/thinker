...
import NormalThinking from "./NormalThinking";
...
function NormalThinkingCollect({ kind }: { kind: string }) {
    ...
    const normalThinkingResponse = {
        contents: {
            dtos: [
                {
                    thinkingId: 14,
                    thinkingThumbnail: ["https://assets.paintingco.com/dev-3/wp-content/uploads/20230802110655/shutterstock_1561397020-scaled.jpg"],
    ...
    return (
        <Stack width={'1084px'} height={'100%'} display={'flex'} flexWrap={'wrap'} flexDirection={'row'}>
