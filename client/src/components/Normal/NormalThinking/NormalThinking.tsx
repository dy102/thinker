...
import { NormalThinkingBox, NormalThinkingNonThumbnail, NormalThinkingThumbnail } from "./NormalThinking.style";
...
function NormalThinking({
    ...
    return (
        <NormalThinkingBox>
            <Stack width={'70%'} paddingTop={'50px'} paddingLeft={'20px'} flexDirection={'column'}>
                <Stack fontSize={'25px'} marginBottom={'60px'}>{thinkingTitle}</Stack>
            ...
            <Stack width={'30%'}>
                {thinkingThumbnail === null ? (
                    ...
                    <NormalThinkingThumbnail imagesrc={thinkingThumbnail}></NormalThinkingThumbnail>
                )
